...
function App() {
  ...
  useEffect(() => {
    const getLogo = (school) => {
      ...
      try {
        ...
        if (dataType === "fresh") {
          team = logos.find(
            (logo) => school.includes(logo.Name) && school.includes(logo.School)
          );
        } else {
        ...
        console.log("Error: ", e);
        url =
          "https://upload.wikimedia.org/wikipedia/commons/thumb/d/dd/NCAA_logo.svg/117px-NCAA_logo.svg.png?20171117030529";
      }
      return url;
    };
    if (gameData !== "none") {
  ...
  return (
    <div className="App">
      ...
      <Score score={score} userName={userName} yourScore={yourScore} />
      <footer>
        Built by <a href="https://github.com/Scott-Andermann">Scott</a> -
        Powered by <a href="https://collegefootballdata.com/">CFBD</a>
      </footer>
    </div>
  );
}
